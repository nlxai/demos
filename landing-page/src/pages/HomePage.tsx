...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-nlx-offwhite-1">
      ...
      <main className="flex-grow max-w-container mx-auto px-5 lg:px-10 py-8 md:py-10 lg:py-12">
        <section className="mb-8 md:mb-12 lg:mb-16">
          <h2 className="text-h2 text-nlx-black mb-6 md:mb-8 text-center">Available Demos</h2>
